...
class SharedViewModelTest {
    ...
    fun screenStateCurrentShoppingList() {
        ...
        sharedViewModel.pushBackStack(ScreenState.CurrentShoppingList)
        assertThat(getValue(sharedViewModel.screenState).shoppingListsUi).isInstanceOf(ResultStatus.Success::class.java)
    }
    ...
    fun screenStateProductList() {
        ...
        sharedViewModel.pushBackStack(ScreenState.CurrentProductList(shoppingList))
        assertThat(getValue(sharedViewModel.screenState).productListUi).isInstanceOf(ResultStatus.Success::class.java)
    }
